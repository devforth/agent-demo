...
This scaffold was generated with `pnpm`. Use `pnpm` commands in this project unless you intentionally migrate the tooling.
...
- `schema.prisma` is the schema and migration source if you use Prisma for this app.
...
- Start the app locally: `pnpm dev`
- Apply local migrations: `pnpm migrate:local`
- Create a new migration and apply it locally: `pnpm makemigration --name <change-name>`
...
- If you change `schema.prisma`, create and apply a migration locally before testing the UI.
